...
export const CATALOGO_SERVICIOS_SEED: CatalogoServicio[] = [
  ...
  { id: "JUR-C003", puestoResponsable: "Gerente Juridico", servicio: "Integracion de expediente bancario", solicitanteTipico: "Finanzas / Tesoreria", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C005", puestoResponsable: "Mesa de Control", servicio: "Alta / renovacion de proveeduria (gobierno)", solicitanteTipico: "Comercial / Operaciones", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C006", puestoResponsable: "Mesa de Control", servicio: "Alta de proveeduria comercial (IP)", solicitanteTipico: "Comercial", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C007", puestoResponsable: "Mesa de Control", servicio: "Carta de devolucion de prima de seguro", solicitanteTipico: "Finanzas / Comercial", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C008", puestoResponsable: "Mesa de Control", servicio: "Validacion de carta de cambio / firmas", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C009", puestoResponsable: "Mesa de Control", servicio: "Alta de cliente / KYC", solicitanteTipico: "Comercial", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C010", puestoResponsable: "Mesa de Control", servicio: "Consulta SIGER / SEGURE", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C012", puestoResponsable: "Mesa de Control", servicio: "Resguardo / digitalizacion de documento", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C013", puestoResponsable: "Mesa de Control", servicio: "Integracion de expediente legal", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C014", puestoResponsable: "Abogado Corporativo", servicio: "Alta / gestion de proveeduria federal", solicitanteTipico: "Comercial / Operaciones", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C018", puestoResponsable: "Abogado Corporativo", servicio: "Aviso de privacidad / atencion ARCO", solicitanteTipico: "RH / Comercial", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C025", puestoResponsable: "Abogado Corporativo", servicio: "Movimiento de Registro Patronal", solicitanteTipico: "RH", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C031", puestoResponsable: "Abogado Comercial", servicio: "Gestion de garantia contractual", solicitanteTipico: "Comercial / Finanzas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C038", puestoResponsable: "Abogado Comercial", servicio: "Revision legal de formato ST7", solicitanteTipico: "Comercial", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C057", puestoResponsable: "Abogado Regional", servicio: "Validacion de expediente de arrendador", solicitanteTipico: "Operaciones", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C059", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Orden de compra (ODC)", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C060", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Comprobacion de egreso", solicitanteTipico: "Finanzas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C061", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Pago a proveedor", solicitanteTipico: "Proveedores / areas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C062", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Requisicion de insumos / papeleria", solicitanteTipico: "Area legal", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C063", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Digitalizacion de expediente (proyecto)", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C064", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Carta responsiva de licenciamiento", solicitanteTipico: "Comercial / Operaciones", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C065", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Carga documental D32", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C066", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Carga de estados bancarios", solicitanteTipico: "Finanzas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C067", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Carga D32 (frentes comerciales)", solicitanteTipico: "Comercial", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  { id: "JUR-C068", puestoResponsable: "Aux. Gestion Documental y Pagos", servicio: "Carga de comprobante de domicilio", solicitanteTipico: "Areas internas", categoria: "Control documental", slaInterno: 1, slaDespachoRef: 3 },
  ...
  { id: "JUR-C074", puestoResponsable: "Abogado Regional", servicio: "Atencion a Arrendamiento", solicitanteTipico: "Operaciones", categoria: "Arrendamientos", slaInterno: 2, slaDespachoRef: 4 },
];
